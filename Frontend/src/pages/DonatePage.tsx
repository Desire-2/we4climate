    ...
    >
      <div className="bg-emerald-950 text-white py-16 mb-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center md:text-left">
          <span className="text-xs font-bold uppercase tracking-widest text-emerald-300">Support Restoration</span>
          <h1 className="mt-2 font-display font-medium text-4xl sm:text-5xl text-white tracking-tight">Donation Terminal</h1>
          <p className="mt-4 text-emerald-100/90 text-sm sm:text-base max-w-2xl leading-relaxed">
            Send dynamic simulated tokens, secure official tax offsets, or back sustainable seed supplies.
          </p>
        </div>
      </div>
